...
$('#help-btn').on('click',function(){
  alert("【ヘルプ】\n\n《カレンダー》\n日付をクリックし、ボタン（「追加」、「変更」、「休日追加」、「休日変更」）を押し、内容を入力、「OK」を押すことで、予定・休日設定を追加・変更できます。\n\n日付をクリックし、「削除」・「休日削除」ボタンを押し、「OK」を押すことで削除できます。\n\n《TODOリスト》\nテキストボックスに内容を記述し、「追加」ボタンを押すことで、TODOを追加できます。\n\nリストから変更したいものをクリックし、「変更」ボタンを押し、内容を記述、「OK」を押すことでTODOの内容を変更できます。\n\nリストから削除したいものをクリックし、「削除」ボタンを押し、「OK」を押すことで、TODOを削除できます。");
});
